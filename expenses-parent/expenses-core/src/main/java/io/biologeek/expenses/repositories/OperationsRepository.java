...
public interface OperationsRepository extends JpaRepository<Operation, Long> {
	...
	public List<Operation> getGroupedByDayAndPeriodAndTypeOfOperationsForAccount(@Param("accountId") long account,
			@Param("begin") Date begin, @Param("end") Date end,
			@Param("operationTypes") OperationType... operationTypes);
